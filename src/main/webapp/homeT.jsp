                ...
                <div class="bg-[#ECEEFF] rounded-xl">
                    <div class="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-64">
                        ...
                        <div class="flex justify-between">
                            <button class="bg-[#F4F5FA] px-4 py-3 rounded-full  border border-[#F0F0F6] shadow-xl mt-4 hover:bg-gray-200" onClick = "window.location.href='studentlist.jsp?ccode=<%=rs.getString("ccode")%>'">
...
//                     				ResultSet res = pst2.executeStatement();
                ...
                <div class="bg-[#ECEEFF] rounded-xl">
                    <div class="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-64">
                        ...
                        <div class="flex justify-between">
                            <a href="/Web/accept?ccode=<%= rs.getString("ccode") %>&cname=<%= rs.getString("cname") %>&dept=<%= rs.getString("dept") %>&teacher=<%= rs.getString("teacher") %>">
